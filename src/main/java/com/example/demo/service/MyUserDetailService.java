...
public class MyUserDetailService implements UserDetailsService {
	...
	public User loadUserByUsername(String username) throws UsernameNotFoundException {
		MyUser myUser =
				userRepository.findByUsername(username).orElseThrow(() -> new UsernameNotFoundException("not found"+username));

//		List<GrantedAuthority> authorityList = Arrays.asList(new SimpleGrantedAuthority(myUser.getRoles()));
